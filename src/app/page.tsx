    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden overflow-x-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse animation-delay-400"></div>
          <div className="absolute top-1/2 right-1/3 w-24 h-24 sm:w-48 sm:h-48 bg-cyan-500/10 rounded-full blur-3xl animate-pulse animation-delay-800"></div>
        </div>
