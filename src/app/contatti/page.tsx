              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+390212345678" className="hover:text-blue-600 transition-colors">
                        +39 02 1234 5678
                      </a><br />
                      <span className="text-sm text-gray-500">Numero Verde: </span>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@nebulatech.com" className="hover:text-blue-600 transition-colors">
                        info@nebulatech.com
                      </a><br />
                      <a href="mailto:supporto@nebulatech.com" className="hover:text-blue-600 transition-colors text-sm">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Orari di Ufficio</h3>
                    <p className="text-gray-600">
                      Lunedì - Venerdì: 9:00 - 18:00<br />
                      Sabato: 9:00 - 13:00<br />
                      <span className="text-sm text-blue-600 font-medium">Supporto 24/7 disponibile</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 disabled:bg-blue-400 transition-colors flex items-center justify-center space-x-2"
              >
                {isSubmitting ? (
                  <>
